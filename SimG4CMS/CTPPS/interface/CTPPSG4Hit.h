#ifndef _CTPPS_G4Hit_h
#define _CTPPS_G4Hit_h 1
// -*- C++ -*-
//
// Package:     CTPPS
// Class  :     CTPPSG4Hit
//
/**\class CTPPSG4Hit CTPPSG4Hit.h SimG4CMS/Forward/interface/CTPPSG4Hit.h
...
class CTPPSG4Hit : public G4VHit {
...
public:
  ...
  CTPPSG4Hit();
  ~CTPPSG4Hit();
  CTPPSG4Hit(const CTPPSG4Hit &right);

  // ---------- operators ----------------------------------
  const CTPPSG4Hit& operator=(const CTPPSG4Hit &right);
  int operator==(const CTPPSG4Hit &){return 0;}
  ...
  void         addEnergyDeposit(const CTPPSG4Hit& aHit);
...
std::ostream& operator<<(std::ostream&, const CTPPSG4Hit&);
