...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef CTPPS_CTPPS_Timing_G4Hit_h
#define CTPPS_CTPPS_Timing_G4Hit_h 1
...
class CTPPS_Timing_G4Hit : public G4VHit {
  
public:
  CTPPS_Timing_G4Hit();
  ~CTPPS_Timing_G4Hit();
  CTPPS_Timing_G4Hit(const CTPPS_Timing_G4Hit &right);
  const CTPPS_Timing_G4Hit& operator=(const CTPPS_Timing_G4Hit &right);
  int operator==(const CTPPS_Timing_G4Hit &){return 0;}
...
private:
  ...
  int theTrackID;        //Identification number of the primary
                                  //particle
  uint32_t theUnitID;         //CTPPS Unit Number
...
std::ostream& operator<<(std::ostream&, const CTPPS_Timing_G4Hit&);

#endif  //CTPPS_CTPPS_Timing_G4Hit_h
