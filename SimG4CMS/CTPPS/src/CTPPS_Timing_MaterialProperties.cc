 /** \file CTPPS_Timing_MaterialProperties.cc
  *  
  *
...
#include "G4PhysicalVolumeStore.hh"
     ...
     CTPPS_Timing_MaterialProperties::CTPPS_Timing_MaterialProperties(int DebugLevel) 
 ...
 CTPPS_Timing_MaterialProperties::~CTPPS_Timing_MaterialProperties()
 {
 ...
 void CTPPS_Timing_MaterialProperties::setMaterialProperties()
 {
     /* *********************************************************************** */
     /* 
...
//         std::cout<<"theLogicalVolume)->GetName() ::"<<(*theLogicalVolume)->GetName()<<std::endl;
  ...
  //       std::cout<<"The debug level::"<<theMPDebugLevel<<std::endl;
         ...
         if ( (*theLogicalVolume)->GetName() == "CTPPS_Timing_Box_First"||(*theLogicalVolume)->GetName() == "CTPPS_Timing_Box_Second"  )
         {
         // set the material
...
CTPPS_Timing_MaterialProperties::SetSurfaceProperties(OpSilSurface);

 } // End of set material function.

void CTPPS_Timing_MaterialProperties::SetSurfaceProperties(G4OpticalSurface* OpSilSurface){
    ...
    // loop over the physical volumes and make the logicalbordersurface
     ...
     for ( thePhysicalVolume = thePhysicalVolumeStore->begin(); thePhysicalVolume != thePhysicalVolumeStore->end(); thePhysicalVolume++ )
       {
           if((*thePhysicalVolume)->GetName() == "CTPPS_Timing_Box_First"&&(*thePhysicalVolume)->GetCopyNo() ==110)
             TIMINGBOX_FR = *thePhysicalVolume;
           if((*thePhysicalVolume)->GetName() == "CTPPS_Timing_Box_Second"&&(*thePhysicalVolume)->GetCopyNo() ==110)
             TIMINGBOX_SR = *thePhysicalVolume;
           if((*thePhysicalVolume)->GetName() == "CTPPS_Timing_Box_First"&&(*thePhysicalVolume)->GetCopyNo() ==10)
             TIMINGBOX_FL = *thePhysicalVolume;
           if((*thePhysicalVolume)->GetName() == "CTPPS_Timing_Box_Second"&&(*thePhysicalVolume)->GetCopyNo() ==10)
...
//PPS_Timing_MaterialProperties::DumpSurfaceInfo();
 ...
 void CTPPS_Timing_MaterialProperties::DumpSurfaceInfo(){
