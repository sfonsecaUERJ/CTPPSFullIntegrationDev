...
//
CTPPSPixelOrganization :: CTPPSPixelOrganization() : // _needUpdateUnitID(false),
					      ...
					      //	_currentObjectType(Undefined) 
{
  ...
  edm::LogInfo("CTPPSSim") << "Creating CTPPSPixelOrganization";
...
CTPPSPixelOrganization :: ~CTPPSPixelOrganization() {
}
...
uint32_t CTPPSPixelOrganization :: GetUnitID(const G4Step* aStep) const {
  return const_cast<CTPPSPixelOrganization *>(this)->GetUnitID(aStep);
}


uint32_t CTPPSPixelOrganization :: GetUnitID(const G4Step* aStep) {

//  std::cout << " INSIDE CTPPSPixelOrganization :: GetUnitID " << std::endl;
...
/*
    ...
    std::cout<< " ***** WARNING TO BE FIXED: using  RP_box_secondary_vacuum to select Arm in CTPPSPixelOrganization.cc. " <<std::endl; 
*/
...
//    _currentRP = 0; 
//    std::cout<< " **** WARNING TO BE FIXED: using _currentRP = 0 in CTPPSPixelOrganization.cc " <<std::endl; 
