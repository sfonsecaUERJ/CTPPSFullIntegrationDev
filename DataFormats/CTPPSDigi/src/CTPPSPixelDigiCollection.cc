...
void CTPPSPixelDigiCollection::put(Range input, unsigned int detID) {
  ...
  CTPPSPixelDigiCollection::ContainerIterator sort_begin = input.first;
  CTPPSPixelDigiCollection::ContainerIterator sort_end = input.second;
  ...
  CTPPSPixelDigiCollection::ContainerIterator begin = temporary.begin();
  CTPPSPixelDigiCollection::ContainerIterator end = temporary.end();
  for ( ;begin != end; ++begin ) {
...
const std::vector<unsigned int> CTPPSPixelDigiCollection::detIDs() const {
  ...
  CTPPSPixelDigiCollection::RegistryIterator begin = map_.begin();
  CTPPSPixelDigiCollection::RegistryIterator end   = map_.end();
