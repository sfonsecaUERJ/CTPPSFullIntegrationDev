#ifndef SimCTPPS_CTPPSPixelDigiProducer_ENERGY_DEPOSIT_UNIT_H
#define SimCTPPS_CTPPSPixelDigiProducer_ENERGY_DEPOSIT_UNIT_H
...
#endif  //SimCTPPS_CTPPSPixelDigiProducer_ENERGY_DEPOSIT_UNIT_H
